...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.contexthub-service.generic.xml
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.usb-service.xml
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/manifest_input.processor-service.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/manifest_wifi_ext.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/nfc-service-default.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/rebootescrow-citadel.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/vendor.google.google_battery-default.xml
